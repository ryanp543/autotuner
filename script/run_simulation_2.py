...
# FILEPATH
# Change location
FILEPATH = './src/robot_description/script/TrajectoryPlanner/planned_trajectory3.csv'
...
if __name__ == "__main__":
    ...
    # Chassis angle data
    filepath = './src/robot_description/script/SimulationData/TrajOnly/sim_data_chassis.csv'
    ...
    # Joint 1 data
    filepath = './src/robot_description/script/SimulationData/TrajOnly/sim_data_joint1.csv'
    with open(filepath, 'wb') as myfile:
        csvwriter = csv.writer(myfile, delimiter=',')
    ...
    # Joint 2 data
    filepath = './src/robot_description/script/SimulationData/TrajOnly/sim_data_joint2.csv'
    with open(filepath, 'wb') as myfile:
        csvwriter = csv.writer(myfile, delimiter=',')
    ...
    # Joint 3 data
    filepath = './src/robot_description/script/SimulationData/TrajOnly/sim_data_joint3.csv'
    with open(filepath, 'wb') as myfile:
        csvwriter = csv.writer(myfile, delimiter=',')
