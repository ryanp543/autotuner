...
In the outermost package directory, there are several folders involved in the simulation. The meshes folder contains all the STL files of the Bioinstrumentation Lab agricultural robot prototype, Rover II. 
